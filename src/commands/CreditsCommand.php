...
class CreditsCommand extends Command
{
    ...
    {
        if (!$this->functions->checkForPermission($sender, "c20s-credits.use"))
            return false;
        ...
        switch ($args[0]) {
            case "check":
                if (!$this->functions->checkForPermission($sender, "c20s-credits.check"))
                    return false;
                ...
                return false;
            case "add":
                if (!$this->functions->checkForPermission($sender, "c20s-credits.add"))
                    return false;
                ...
                return false;
            case "reduce":
                if (!$this->functions->checkForPermission($sender, "c20s-credits.reduce"))
                    return false;
                ...
                return false;
            case "set":
                if (!$this->functions->checkForPermission($sender, "c20s-credits.set"))
                    return false;
                ...
                return false;
            case "reset":
                if (!$this->functions->checkForPermission($sender, "c20s-credits.reset"))
                    return false;
                ...
                return false;
            case "reload":
                if (!$this->functions->checkForPermission($sender, "c20s-credits.reload"))
                    return false;
